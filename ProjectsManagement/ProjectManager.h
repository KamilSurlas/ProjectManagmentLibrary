...
public:
	...
	bool removeUserFromTask(Project& project, Task& task, User& user) override;
	void assignLeaderToTask(Project& project, Task& task, User& leader) override;
	bool removeLeaderFromTask(Project& project, Task& task, User& leader) override;
	...
	bool removeUserFromProject(Project& project, User& user) override;
	void assignManagerToProject(Project& project, User& manager) override;
	bool removeManagerFromProject(Project& project, User& manager) override;
