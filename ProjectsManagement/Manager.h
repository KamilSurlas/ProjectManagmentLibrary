...
protected:
	...
	virtual User* removeUserFromTask(Project& project, Task& task, User& user) = 0;
	virtual void assignLeaderToTask(Project& project, Task& task, User& leader) = 0;
	virtual User* removeLeaderFromTask(Project& project, Task& task, User& leader) = 0;
	...
	virtual User* removeUserFromProject(Project& project, User& user) = 0;
	virtual void assignManagerToProject(Project& project, User& manager) =0;
	virtual bool removeManagerFromProject(Project& project)=0;
